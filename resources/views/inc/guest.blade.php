    ...
    <a id="htmlGuest" href="/logout">
        @if(env('APP_SYS') == 'DD')
            <div style="text-align: center;">
                <img class="text-center p-2 animate__animated animate__bounceIn" src="{{asset('inc/Dunkin.png')}}" style="width: auto; height: 150px;">
            </div>
        ...
        @else
            <div style="text-align: center; background-color: #850708">
                <img class="text-center p-2 animate__animated animate__bounceIn" src="{{env('APP_URL')}}/inc/MaryGrace.jpg" style="width: auto; height: 150px;">
            </div>
