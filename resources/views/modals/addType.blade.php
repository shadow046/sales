    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-default">
                <h5 class="modal-title w-100 text-center">STORE TYPE DETAILS</h5>
            ...
            <div class="modal-body">
                <div class="row mb-3">
                    <div class="col-md f-outline">
                        <input type="search" style="color: black" name="type" id="type" class="forminput form-control requiredField text-uppercase stringOnly" placeholder=" " autocomplete="off" >
                        <p class="validation"><i class="fas fa-exclamation-triangle"></i> ALREADY EXIST!</p>
                        <label for="type" class="formlabels form-label">STORE TYPE</label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md f-outline">
