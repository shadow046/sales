        ...
        <div class="modal-content card">
            ...
            <div class="modal-body" style="background-color: white; color: black;">
                <form id="formUpload" action="/company/import" method="post" enctype="multipart/form-data">
                    ...
                    <a href="/templates/import_companies.xlsx" class="btn btn-primary bp float-end mr-1">DOWNLOAD TEMPLATE</a>
