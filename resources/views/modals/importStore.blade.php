        ...
        <div class="modal-content card">
            ...
            <div class="modal-body" style="background-color: white; color: black;">
                <form id="formUpload" action="/store/import" method="post" enctype="multipart/form-data">
                    ...
                    <a href="/templates/import_store_23030205.xlsx" class="btn btn-primary bp float-end mr-1">DOWNLOAD TEMPLATE</a>
