...
<div class="row">
    ...
    <div class="col-md form-group">
        @can('create')
            <button class="form-control btn btn-custom addBtn float-end" data="network_setup"><i class="fas fa-plus"></i> ADD NEW</button>
        @endcan
...
<script src={{asset('js/maintenance/network_setup.js?ver=')}}{{$random}}></script>
@endsection