...
<div class="row">
    ...
    <div class="col-md form-group">
        @can('create')
            <button class="btn btn-custom addBtn float-end" data="transactionType"><i class="fas fa-plus"></i> ADD NEW</button>
        @endcan
...
<script src={{asset('js/maintenance/transaction_type.js?ver=')}}{{\Illuminate\Support\Str::random(50)}}></script>
@endsection